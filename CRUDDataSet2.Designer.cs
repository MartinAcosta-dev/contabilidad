...
namespace Sistema {
    ...
    public partial class CRUDDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/CRUDDataSet2.xsd";
        ...
        public partial class EmpresasDataTable : global::System.Data.TypedTableBase<EmpresasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmpresasRow AddEmpresasRow(string Nombre, string Localizacion) {
        ...
        public partial class EmpresasRow : global::System.Data.DataRow {
            ...
            public string Localizacion {
                get {
                    try {
                        return ((string)(this[this.tableEmpresas.LocalizacionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Localizacion\' de la tabla \'Empresas\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmpresas.LocalizacionColumn] = value;
                }
            }
            ...
            public bool IsLocalizacionNull() {
                return this.IsNull(this.tableEmpresas.LocalizacionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetLocalizacionNull() {
                this[this.tableEmpresas.LocalizacionColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class EmpresasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Empresas] WHERE (([ID] = @Original_ID) AND ((@IsNull_Nombre = " +
                "1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Localiza" +
                "cion = 1 AND [Localizacion] IS NULL) OR ([Localizacion] = @Original_Localizacion" +
                ")))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Empresas] ([Nombre], [Localizacion]) VALUES (@Nombre, @Localiz" +
                "acion);\r\nSELECT ID, Nombre, Localizacion FROM Empresas WHERE (ID = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empresas] SET [Nombre] = @Nombre, [Localizacion] = @Localizacion WHERE (([ID] = @Original_ID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Localizacion = 1 AND [Localizacion] IS NULL) OR ([Localizacion] = @Original_Localizacion)));
SELECT ID, Nombre, Localizacion FROM Empresas WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nombre, Localizacion FROM dbo.Empresas";
        ...
        public virtual int Fill(CRUDDataSet.EmpresasDataTable dataTable) {
        ...
        public virtual CRUDDataSet.EmpresasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRUDDataSet.EmpresasDataTable dataTable = new CRUDDataSet.EmpresasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRUDDataSet.EmpresasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Nombre, string Original_Localizacion) {
        ...
        public virtual int Insert(string Nombre, string Localizacion) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Localizacion, int Original_ID, string Original_Nombre, string Original_Localizacion, int ID) {
            if ((Nombre == null)) {
            ...
            if ((Original_Localizacion == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Localizacion));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Localizacion, int Original_ID, string Original_Nombre, string Original_Localizacion) {
            return this.Update(Nombre, Localizacion, Original_ID, Original_Nombre, Original_Localizacion, Original_ID);
        }
    }
